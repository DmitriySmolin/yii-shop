...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/price-range.css">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="search_box pull-right">
                        <form method="get" action="<?=Yii::app()->createUrl('category/search')?>">
...
<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery.accordion.js"></script>
<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery.cookie.js"></script>
<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/price-range.js"></script>
